...
np.savetxt("/projects/LEIFER/francesco/funatlas/figures/paper/fig2/AconnHopDepth2_tost.txt", np.array([np.array(labels).astype(float), probs]))
plt.savefig("/projects/LEIFER/francesco/funatlas/figures/paper/fig2/AconnHopDepth2_tost.pdf", bbox_inches='tight')
...
np.savetxt("/projects/LEIFER/francesco/funatlas/figures/paper/fig2/AconnHopDepth_tost.txt", np.array([min_anatomical_hops_flat,min_anatomical_hops_all_flat]))
plt.savefig("/projects/LEIFER/francesco/funatlas/figures/paper/fig2/AconnHopDepth_tost.pdf", bbox_inches='tight')
