...
r_ck_spont_opt_top_n = 13
r_ck_spont_opt_top_n_unc31 = None

r_conn_spont = 0.02
r_kuncorr_spont = 0.12
r_kuncorr_spont_opt = 0.12
r_ck_spont = 0.13
r_ck_spont_opt = 0.50
r_ck_spont_unc31 = 0.03
r_ck_spont_opt_unc31 = np.nan
r_stimcorr_spont = 0.19
...
fig.savefig("/projects/LEIFER/francesco/funatlas/figures/paper/fig5/funatlas_vs_correlations_nth.pdf",dpi=300,bbox_inches="tight")
plt.show()
